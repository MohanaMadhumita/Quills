...
/* Generation options: */
#ifndef __model_mkSched_h__
#define __model_mkSched_h__
...
/* Class declaration for a model of mkSched */
class MODEL_mkSched : public Model {
 
 /* Top-level module instance */
 private:
  MOD_mkSched *mkSched_instance;
...
#endif /* ifndef __model_mkSched_h__ */
